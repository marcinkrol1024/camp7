...
import sages.bootcamp.Notebook;
import sages.bootcamp.NotebookDao;
import sages.bootcamp.NotebookNamedQueryDao;

import javax.persistence.Persistence;
import java.time.Instant;
import java.util.List;

public class NotebookNamedQueryDaoSpec {

  private NotebookDao notebookDao = new NotebookNamedQueryDao(
